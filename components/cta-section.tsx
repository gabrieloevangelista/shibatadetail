    ...
    <section className="w-full pt-20 md:pt-60 lg:pt-60 pb-10 md:pb-20 px-5 relative flex flex-col justify-center items-center overflow-visible">
        ...
        >
          ...
          <defs>
            ...
            >
              ...
              <stop offset="0.2" stopColor="#141414" stopOpacity="0.8" />
              <stop offset="0.8" stopColor="#141414" stopOpacity="0.8" />
      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          <h2 className="w-full text-foreground text-2xl md:text-xl lg:text-4xl font-semibold leading-tight md:leading-tight lg:leading-[48px] break-words">
          ...
          <p className="text-muted-foreground text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
            Transforme seu veículo com nossos serviços premium de estética automotiva. Qualidade, confiança e resultados
            que superam expectativas.
          </p>
        </div>
        <Link href="https://wa.me/5541998760734" target="_blank" rel="noopener noreferrer">
          <Button
            className="px-[30px] py-2 bg-secondary text-secondary-foreground text-base font-medium leading-6 rounded-[99px] shadow-[0px_0px_0px_4px_rgba(255,255,255,0.13)] hover:bg-secondary/90 transition-all duration-200 w-full md:w-auto"
            size="lg"
          >
            Agendar Serviço
          </Button>
